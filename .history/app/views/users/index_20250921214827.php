...
<head>
  ...
  <style>
    ...
    .pagination a {
      @apply inline-block px-4 py-2 bg-pink-500 text-white font-medium rounded-lg 
             shadow hover:bg-pink-600 transition duration-200;
    }
    .pagination strong {
      @apply inline-block px-4 py-2 bg-pink-700 text-white font-semibold rounded-lg shadow;
    }
  </style>
</head>
